...
async function handler(req, res) {
  ...
  if (req.method === "POST") {
    ...
    const data = req.body;
    const client = await mongodb__WEBPACK_IMPORTED_MODULE_0__["MongoClient"].connect('mongodb+srv://user_0:ffang2198@cluster0.1hgvdjv.mongodb.net/?retryWrites=true&w=majority');
    const db = client.db();
